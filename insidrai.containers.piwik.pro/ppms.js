...
! function(n) {
    ...
    "use strict";
    var error_stack_parser__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1),
        error_stack_parser__WEBPACK_IMPORTED_MODULE_0___default = __webpack_require__.n(error_stack_parser__WEBPACK_IMPORTED_MODULE_0__);

    function getPerformanceAPI(e) {
        var t = e.performance || e.mozPerformance || e.msPerformance || e.webkitPerformance;
        return isDefined(t) && isDefined(t.timing) ? t.timing : isDefined(t) && isDefined(t.getEntriesByType) ? t.getEntriesByType("navigation")[0] : void 0
    }
    var expireDateTime, plugins = {},
        ...
        screenAlias = screen,
        windowAlias = window,
        pagePerformanceMetricsAlreadySent = !1,
    ...
    function isNumberRepresentation(e) {
        return "number" == typeof e || isString(e) && !isNaN(e) && "" !== e
    }
    ...
    function apply() {
        for (var e, t, n, i = 0; i < arguments.length; i += 1) {
            var r, o = null;
            if (arguments[i] && arguments[i].slice && (o = arguments[i].slice()), isString(t = (n = arguments[i]).shift()) && 0 < t.indexOf("::")) a = (r = t.split("::"))[0], t = r[1], "object" == typeof Piwik[a] && "function" == typeof Piwik[a][t] ? Piwik[a][t].apply(Piwik[a], n) : o && missedPluginTrackerCalls.push(o);
            else
                for (e = 0; e < asyncTrackers.length; e++)
                    if (isString(t)) {
                        var a = asyncTrackers[e];
                        if (0 < t.indexOf("."))
                            if (r = t.split("."), a && "object" == typeof a[r[0]]) a = a[r[0]], t = r[1];
                            else if (o) {
                            missedPluginTrackerCalls.push(o);
                            break
                        }
                        if (a[t] ? a[t].apply(a, n) : logConsoleError("The method '" + t + '\' was not found in "_paq" variable.  Please have a look at the Piwik tracker documentation'), "addTracker" === t) break;
    ...
    function removeEventListener(e, t, n, i) {
        return e.removeEventListener ? (e.removeEventListener(t, n, i), 1) : e.detachEvent ? e.detachEvent("on" + t, n) : void(e["on" + t] === n && delete e["on" + t])
    }
    ...
    function getHost(e) {
        var t = documentAlias.createElement("a");
    ...
    function addUrlParameter(e, t, n) {
        e = String(e), n = n || "";
        var i = documentAlias.createElement("a");
        i.href = e;
        var r = i.search.split("&");
        return r.push(encodeWrapper(t) + "=" + encodeWrapper(n)), "" === r[0] && r.shift(), i.search = r.join("&"), i.href
    }
    ...
    function sha1(e) {
        for (var t, n, i, r, o, a, s, c, u = function(e, t) {
                ...
                return t
            }, d = [], f = 1732584193, g = 4023233417, m = 2562383102, h = 271733878, p = 3285377520, k = [], v = (e = utf8_encode(e)).length, C = 0; C < v - 3; C += 4) n = e.charCodeAt(C) << 24 | e.charCodeAt(C + 1) << 16 | e.charCodeAt(C + 2) << 8 | e.charCodeAt(C + 3), k.push(n);
        switch (3 & v) {
            case 0:
                C = 2147483648;
                break;
            case 1:
                C = e.charCodeAt(v - 1) << 24 | 8388608;
                break;
            case 2:
                C = e.charCodeAt(v - 2) << 24 | e.charCodeAt(v - 1) << 16 | 32768;
                break;
            case 3:
                C = e.charCodeAt(v - 3) << 24 | e.charCodeAt(v - 2) << 16 | e.charCodeAt(v - 1) << 8 | 128
        }
    ...
    function Tracker(trackerUrl, siteId) {
        var registeredHooks = {},
            ...
            sessionIdStrictPrivacyMode = !1,
            lastPageViewWasAnonymous = null,
            lastPageViewHadCookie = null,
            configUserId = "",
            visitorUUID = "",
            configUpdateTimingDataOnPageLoadSampling = 10,
            ...
            configHeartBeatDelay, heartBeatPingIfActivityAlias, configDiscardHashTag, configCustomData, configCookieNamePrefix = "_pk_",
            configVisitorIdUrlParameter = "pk_vid",
            configVisitorIdUrlParameterTimeoutInSeconds = 180,
            configCookieDomain, configCookiePath, configCookieIsSecure = !1,
            configCookiesDisabled = !1,
            configSiteInspectorSetup = !0,
            ...
            crossDomainTrackingLinkDecorator = function(e, t, n) {
                return addUrlParameter(removeUrlParameter(e, n), n, t)
            },
            ...
            onlyUniqueJavaScriptErrors = !1,
            javaScriptErrors = [],
            configCookiesToDelete = ["id", "ses", "cvar"],
            trackingSourceName = "jstc",
            trackingSourceVersion = "2.11.1";
        try {
        ...
        function sendRequest(t, n, i, e, r, o) {
            ...
            o = !isDefined(o) || o, !configDoNotTrack && t && (a = r || configRequestMethod, s = !i && navigatorAlias.sendBeacon && windowAlias.Blob && t.length <= 65536, c = !0, u = function() {
                ...
                }), navigatorAlias.sendBeacon(configTrackerUrl, e) ? c = !1 : sendXmlHttpRequest(t, i)) : ("POST" === a || 2e3 < String(t).length ? sendXmlHttpRequest : getImage)(t, i), c && setExpireDateTime(n)
        ...
        function hasCookies() {
            ...
            var e = getCookieName("_pk_testcookie");
            setCookie(e, "1", configCookiePath, configCookieDomain, configCookieIsSecure);
            var t = "1" === getCookie(e) ? "1" : "0";
            return deleteCookie(e, configCookiePath, configCookieDomain, configCookieIsSecure), t
        }
        ...
        function transformIfAMPCookie(e) {
            var t, n = [
                [/g/g, "10"],
                [/h/g, "11"],
                [/i/g, "12"],
            ...
            if (e && !/^[0-9a-f]{16}$/.test(e)) {
                for (e = e.toLowerCase().substr(4, 16), t = 0; t < n.length; t += 1) e = e.replace(n[t][0], n[t][1]);
                e = e.substr(0, 16)
            }
            return e
        }
        ...
        function loadVisitorIdCookie() {
            ...
            return i ? ((e = i.split("."))[0] = transformIfAMPCookie(e[0]), e.length < 6 && (e[1] = n, e[2] = 0, e[3] = n, e[4] = "", e[5] = ""), e.unshift("0"), visitorUUID.length && (e[1] = visitorUUID), e) : e = ["1", visitorUUID.length ? visitorUUID : "0" === hasCookies() ? "" : generateRandomUuid(), n, 0, n, "", ""]
        }
        ...
        function deleteCookie(e, t, n, i) {
            setCookie(e, "", -86400, t, n, i)
        }

        function deleteCookies() {
            var e, t, n = configCookiesDisabled;
            for (configCookiesDisabled = !1, e = 0; e < configCookiesToDelete.length; e++) 0 !== getCookie(t = getCookieName(configCookiesToDelete[e])) && deleteCookie(t, configCookiePath, configCookieDomain, configCookieIsSecure);
            configCookiesDisabled = n
        }

        function siteInspectorSetUp(e, t) {
            var n = documentAlias.createElement("script");
            n.setAttribute("id", "ppas_container_configuration"), n.setAttribute("data-appid", t), n.setAttribute("data-host", getHost(e)), documentAlias.getElementsByTagName("head")[0].appendChild(n)
        }

        function setSiteId(e) {
            configTrackerSiteId = e, setVisitorIdCookie(), configSiteInspectorSetup && siteInspectorSetUp(this.getTrackerUrl(), e)
        }
        ...
        function getRequest(e, t, n, i) {
            ...
            var C = sortObjectByKeys(customVariablesPage),
                T = sortObjectByKeys(customVariablesEvent);
            if (e += v(C, "cvar"), e += v(T, "e_cvar"), customVariables) {
                for (r in e += v(customVariables, "_cvar"), s) Object.prototype.hasOwnProperty.call(s, r) && ("" !== customVariables[r][0] && "" !== customVariables[r][1] || delete customVariables[r]);
            ...
            var b, w, y, A, I, E, N = getPerformanceAPI(windowAlias),
                S = null;
        ...
        function logEcommerce(e, t, n, i, r, o) {
            var a, s, c = "idgoal=0",
                ...
                l = [],
                d = String(e).length;
            if (c += "&" + getActionNameParam(""), d && (c += "&ec_id=" + encodeWrapper(e), a = Math.round(u.getTime() / 1e3)), c += "&revenue=" + t, isNumberRepresentation(n) && (c += "&ec_st=" + n), isNumberRepresentation(i) && (c += "&ec_tx=" + i), isNumberRepresentation(r) && (c += "&ec_sh=" + r), isNumberRepresentation(o) && (c += "&ec_dt=" + o), ecommerceItems) {
        ...
        function getActionNameParam(e) {
            return "action_name=" + encodeWrapper(titleFixup(e || configTitle))
        }

        function logPageView(e, t, n) {
            configIdPageView = generateUniqueId(), sendRequest(getRequest(getActionNameParam(e), t, "log"), configTrackerPause, n)
        }
        ...
        function getLinkIfShouldBeProcessed(e) {
            if ((e = getSourceElement(e), query.hasNodeAttribute(e, "href")) && (isDefined(e.href) && !startsUrlWithTrackerUrl(query.getAttributeValueFromNode(e, "href")))) {
                ...
                if (!new RegExp("^(javascript|vbscript|jscript|mocha|livescript|ecmascript|mailto|tel|data|blob):", "i").test(r)) {
        ...
        function logSiteSearch(e, t, n, i) {
            sendRequest(getRequest("search=" + encodeWrapper(e) + (t ? "&search_cats=" + encodeWrapper(JSON.stringify(isString(t) ? [t] : t)) : "") + (isDefined(n) ? "&search_count=" + n : ""), i, "sitesearch"), configTrackerPause)
        }

        function logGoal(e, t, n) {
            sendRequest(getRequest("idgoal=" + e + (t ? "&revenue=" + t : "") + "&" + getActionNameParam(""), n, "goal"), configTrackerPause)
        }
        ...
        function processClick(e) {
            ...
            t && t.type ? logLink(t.href, t.type, void 0, null, e) : crossDomainTrackingEnabled && isLinkToDifferentDomainButSamePiwikWebsite(e = getSourceElement(e)) && replaceHrefForCrossDomainLink(e)
        }
        ...
        function addClickListeners(n) {
            function e(e) {
                var t = closestAnchor(e.target);
                linkTrackingEnabled && t && !getClassesRegExp(configIgnoreClasses, "ignore").test(t.className) && clickHandler(n)(e)
            }
            linkTrackingInstalled || (addEventListener(document.body, "click", e, !1), n && (addEventListener(document.body, "mouseup", e, !1), addEventListener(document.body, "mousedown", e, !1), addEventListener(document.body, "contextmenu", e, !1)), linkTrackingInstalled = function() {
                removeEventListener(document.body, "click", e, !1), n && (removeEventListener(document.body, "mouseup", e, !1), removeEventListener(document.body, "mousedown", e, !1), removeEventListener(document.body, "contextmenu", e, !1))
            })
        }
        ...
        function logErrorEvent(e, i, r, o) {
            var a = e.substring(0, 16e3);
            enableJSErrorTracking && trackCallback(function() {
                ...
                onlyUniqueJavaScriptErrors && -1 !== indexOfArray(javaScriptErrors, n) || (javaScriptErrors.push(n), logEvent(e, t, a))
            })
        }
        this.setCustomVariableMaximumLength = function(e) {
            customVariableMaximumLength = e
            ...
            "function" == typeof linkTrackingInstalled && linkTrackingInstalled(), linkTrackingEnabled = linkTrackingInstalled = !1
        ...
        }, this.setSiteId = setSiteId, this.setVisitorIdCookie = function() {
            setVisitorIdCookie()
        }, this.resetUserId = function() {
            configUserId = ""
        }, this.setUserIsAnonymous = function(e) {
            configUserIsAnonymous = e
        }, this.setSessionIdStrictPrivacyMode = function(e) {
            sessionIdStrictPrivacyMode = e
            ...
            var t = domainFixup(e);
            configCookieDomain = t, updateDomainHash()
            ...
            deleteCookies()
        }, this.setSiteInspectorSetup = function(e) {
            configSiteInspectorSetup = e
            ...
            this.disableLinkTracking(), void 0 === e && (e = !0), linkTrackingEnabled = !0, trackCallback(function() {
                trackCallbackOnReady(function() {
                    addClickListeners(e)
                })
            })
        }, this.enableJSErrorTracking = function(e) {
            var o;
            isDefined(e) || (e = !0), enableJSErrorTracking || (enableJSErrorTracking = !0, onlyUniqueJavaScriptErrors = e, o = windowAlias.onerror, windowAlias.onerror = function(e, t, n, i, r) {
                return logErrorEvent(e, t, n, i), !!o && o(e, t, n, i, r)
            })
            ...
            }), numTrackedPageviews <= 1 && configUpdateTimingDataOnPageLoadSampling >= Math.floor(100 * Math.random() + 1) && trackCallbackOnLoad(function() {
                setTimeout(function() {
        ...
        }, this.trackError = function(e) {
            var t;
            try {
                t = error_stack_parser__WEBPACK_IMPORTED_MODULE_0___default.a.parse(e)[0]
            } catch (e) {}
            e && e.message && t && logErrorEvent(e.message, t.fileName, t.lineNumber, t.columnNumber)
        ...
        }, this.getTrackingSource = function() {
            return [trackingSourceName, trackingSourceVersion]
        }, this.setTrackingSource = function(e, t) {
            trackingSourceName = String(e), void 0 !== t && (trackingSourceVersion = String(t))
    ...
    var applyFirst = ["addTracker", "disableCookies", "enableCookies", "setSessionIdStrictPrivacyMode", "setTrackerUrl", "setAPIUrl", "enableCrossDomainLinking", "setCrossDomainLinkingTimeout", "customCrossDomainLinkDecorator", "customCrossDomainLinkVisitorIdGetter", "setSecureCookie", "setCookiePath", "setCookieDomain", "setDomains", "setUserId", "setSiteInspectorSetup", "setSiteId", "enableLinkTracking", "setCustomVariableMaximumLength"];
    ...
    function createFirstTracker(e, t) {
        ...
        var i, r, o, a = "Matomo javascript tracker or Piwik PRO javascript tracker was already initiated on this page. Please check the tracker setup. Matomo conflict can be resolved using these instructions: https://help.piwik.pro/support/questions/can-i-use-piwik-pro-and-matomo-at-the-same-time/.";
        return "number" == typeof window._paq.length ? (i = new TrackerProxy, r = new Date, window._paq = i, o = setInterval(function() {
            return 6e4 < new Date - r ? void clearInterval(o) : window._paq !== i ? (logConsoleError(a), void clearInterval(o)) : void 0
        }, 1e3)) : logConsoleError(a), n
    }
    ...
    }, "function" == typeof define && __webpack_require__(3) && define("piwik", [], function() {
        return Piwik
    ...
    ! function() {
        "use strict";
        r = [n(2)], void 0 === (o = "function" == typeof(i = function(c) {
            "use strict";
            var i = /(^|@)\S+:\d+/,
                r = /^\s*at .*(\S+:\d+|\(native\))/m,
                o = /^(eval@)?(\[native code])?$/;
            return {
                parse: function e(t) {
                    ...
                    } else if (t.stack && t.stack.match(r)) {
                ...
                parseV8OrIE: function e(t) {
                    ...
                    return n.map(function(e) {
                        ...
                        var n = t.match(/ (\((.+):(\d+):(\d+)\)$)/);
                        t = n ? t.replace(n[0], "") : t;
                        var i = t.split(/\s+/).slice(1);
                        var r = this.extractLocation(n ? n[1] : i.pop());
                        var o = i.join(" ") || undefined;
                        var a = ["eval", "<anonymous>"].indexOf(r[0]) > -1 ? undefined : r[0];
                        return new c({
                            functionName: o,
                            fileName: a,
                            lineNumber: r[1],
                ...
                parseOpera9: function e(t) {
                    ...
                    var r = [];
                    for (var o = 2, a = i.length; o < a; o += 2) {
                        var s = n.exec(i[o]);
                        if (s) {
                            r.push(new c({
                                fileName: s[2],
                ...
                parseOpera10: function e(t) {
                    ...
                    var r = [];
                    for (var o = 0, a = i.length; o < a; o += 2) {
                        var s = n.exec(i[o]);
                        if (s) {
                            r.push(new c({
    ...
    ! function() {
        ...
        r = [], void 0 === (o = "function" == typeof(i = function() {
            ...
            for (var u = 0; u < t.length; u++) {
                d.prototype["get" + i(t[u])] = e(t[u]);
                d.prototype["set" + i(t[u])] = function(t) {
                    return function(e) {
                        this[t] = Boolean(e)
                    }
                }(t[u])
            ...
            for (var l = 0; l < r.length; l++) {
                d.prototype["get" + i(r[l])] = e(r[l]);
                d.prototype["set" + i(r[l])] = function(t) {
                    return function(e) {
                        if (!n(e)) {
            ...
            for (var f = 0; f < o.length; f++) {
                d.prototype["get" + i(o[f])] = e(o[f]);
                d.prototype["set" + i(o[f])] = function(t) {
                    return function(e) {
                        this[t] = String(e)
                    }
                }(o[f])
